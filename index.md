...
venue: "Newcastle University"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
latitude: "54.9792"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "1.6147"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "11 - 13 April, 2022"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "09:00 - 16:30"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
startdate: 2022-04-11      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2022-04-13       # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Dr. Jannetta Steyn", "Dr. Kate Court"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Imre Draskovits", "Stuart Lewis"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
<p>
 We will provide access to the required software through a web browser. If you wish to setup the software on your own device in the future, you can find instructions below. Please note you may need administrative privileges.
</p>
<p>
